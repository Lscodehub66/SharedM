...
robocopy "\\itd-m09-fs02\dcm$\Team Folder\Execution Team\Rating & Advisory\5. ESG\Pitch book""Z:\Team Folder\Execution Team\DataHub\SharedM\Backup" .xlsx /z 
robocopy "\\itd-m09-fs02\dcm$\0 DCM Base\[DEAL EXECUTION]\KYC & AML" "Z:\Team Folder\Execution Team\DataHub\SharedM\Backup" *.xlsm   /z 
