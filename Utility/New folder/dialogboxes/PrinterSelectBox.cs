...
namespace RobvanderWoude
{
	...
	{
		public static string progver = "2.07";
		...
		public static int ShowHelp( params string[] errmsg )
		{
			...
			*/
			...
			Console.ResetColor( );
			Console.Error.Write( "          make dialog system " );
			Console.ForegroundColor = ConsoleColor.White;
			Console.Error.Write( "M" );
			Console.ResetColor( );
			Console.Error.WriteLine( "odal (i.e. always on top)" );
